    ...
    private void GetAllSelectableNodes()
    {
        ...
        while (BFSQueue.Count > 0) //BFS implementation
        {
            ...
            foreach (NavNode nextBFSNode in currentBFSNode.m_adjacentNodes)
            {
                ...
                {
                    int distance = currentBFSNode.m_BFSDistance - 1; //TODO addiitoinal cost when moving up or down; //Wow adding semicolons to comments, Ive been doing this for far too long...
