...
public class WorldState : ScriptableObject
{
    ...
    public static bool CheckForValidState(GameObject agent, WORLD_STATE state)
    {
        if (m_StateFunctions.ContainsKey(state))
            return m_StateFunctions[state](agent);
        return false;
    }
    ...
    //--------------------------------------------------------------------------------------
    private static bool Idle(GameObject agent)
    {
        return true;
    }
